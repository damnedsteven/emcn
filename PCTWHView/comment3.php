		...
		if (isset($_POST['applyto'])) {
			if ($_POST['applyto'] == 'seta') {
				$query = "  UPDATE Picklist 
							SET Comment10='{$_POST['comment']}', Comment11='{$_POST['comment3']}', Comment12='{$_POST['comment2']}' 
				...
				$query = "UPDATE Picklist SET Comment10='{$_POST['comment']}', Comment11='{$_POST['comment3']}', Comment12='{$_POST['comment2']}' WHERE PLO IN ({$entry}) ";
			} else {
				$query = "UPDATE Picklist SET Comment10='{$_POST['comment']}', Comment11='{$_POST['comment3']}', Comment12='{$_POST['comment2']}' WHERE PLO='{$_GET['PLO']}' ";
			}
		} 
		// var_dump($query);
		// Connect to 112 DB
