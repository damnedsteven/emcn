		...
		if (isset($_POST['applyto'])) {
			if ($_POST['applyto'] == 'seta') {
				$query = "  UPDATE PCTMaster 
							SET Comment='{$_POST['comment']}', Comment2='{$_POST['comment3']}', Comment3='{$_POST['comment2']}' 
				...
				$query = "UPDATE PCTMaster SET Comment='{$_POST['comment']}', Comment2='{$_POST['comment3']}', Comment3='{$_POST['comment2']}' WHERE PLO IN ({$entry}) ";
			} else {
				$query = "UPDATE PCTMaster SET Comment='{$_POST['comment']}', Comment2='{$_POST['comment3']}', Comment3='{$_POST['comment2']}' WHERE PLO='{$_GET['PLO']}' ";
			}
		} 
		// var_dump($query);
		// Connect to 112 DB
